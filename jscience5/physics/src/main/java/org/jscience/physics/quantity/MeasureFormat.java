...
//			}
		...
		public AbstractMeasurement<?> parse(CharSequence csq, ParsePosition cursor)
			...
			if (number instanceof BigDecimal)
				return AbstractMeasurement.valueOf((BigDecimal) number, unit);
			else if (number instanceof Long)
				return AbstractMeasurement.valueOf(((Long) number).longValue(), unit);
			else if (number instanceof Double)
				return AbstractMeasurement.valueOf(((Double) number).doubleValue(), unit);
			else
...
//			}
		...
		public AbstractMeasurement<?> parse(CharSequence csq, ParsePosition cursor)
			...
			return AbstractMeasurement.valueOf(decimal, unit);
		}
	}
}