...
/**
 * <p>
 * This interface represents a determinate {@link Quantity quantity} (as of
 ...
 * usually a unit not convertible to its {@link #toMetric metric unit}. Such
 ...
 * @version 1.1 ($Revision: 58 $), $Date: 2010-08-28 17:33:53 +0200 (Sa, 28 Aug 2010) $
 */
public interface Unit<Q extends Quantity<Q>> {
     ...
     * 
     * @return this unit symbol or <code>null</code> if this unit has no
     ...
     * 
     * <p>
     * Metric units are either base units, {@link #alternate alternate units} or
     * product of rational powers of metric units.
     * </p>
     * 
     * <p>
     ...
     * unknown at compile-time or when dimensional analysis allows for
     ...
     * ONE.alternate("rad").asType(Angle.class); Unit<Force> NEWTON =
     * METRE.times
     * (KILOGRAM).divide(SECOND.pow(2)).alternate("N").asType(Force.class);
    ...
    /**
     * Returns the result of multiplying this unit by the specified factor. If
     * the factor is an integer value, the multiplication is exact
    ...
    /**
     * Returns the result of dividing this unit by an approximate divisor. If
