...
public class BitRateQuantity extends TestNumericQuantity {
	...
	// public DistanceNumericQuantity divide(DistanceNumericQuantity d1) {
	// BitRateQuantity dq0 = convert(AreaUnit.sqmetre);
	// DistanceNumericQuantity dq1 = d1.convert(DistanceUnit.m);
	// return new DistanceNumericQuantity(dq0.units / dq1.units, DistanceUnit.m);
	// }
	// public VolumeNumericQuantity multiply(DistanceNumericQuantity d1) {
	// BitRateQuantity dq0 = convert(BitRateUnit.bps);
	// DistanceNumericQuantity dq1 = d1.convert(DistanceUnit.m);
	// return new VolumeNumericQuantity(dq0.units * dq1.units, VolumeUnit.cumetre);
	// }
