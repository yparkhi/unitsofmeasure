 ...
 * would have many of the units held by {@link USCustomary}).
 * </p>
 * 
...
public abstract class SystemOfUnits {
	 ...
	 * (convenience method). This method returns all the units in this system of
	 * units having the specified dimension.
	 * 
	 * @param dimension
